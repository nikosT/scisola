...
c        write(*,*) xmstrike,xmdip,xmrake
c        write(*,*) xastrike,xadip,xarake
        
        
      if(xmstrike.eq.xastrike.and.xmdip.eq.xadip.and.xmrake
     &.eq.xarake) then
        rotangle=0.0
        write(*,*) rotangle
      else
      CALL MINDCROT 
     *(xmstrike,xmdip,xmrake,xastrike,xadip,xarake,rotangle,theta,phi)
        write(*,*) rotangle
      endif
