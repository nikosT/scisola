      program ISOLA15                                                                  
c        POZOR - pokud se zmeni pocet bodu pri vypocet VR tak zmenit take manidata15.inc
c           !!!!!!!!!!!!!!!!!!!!

c     mixing GPS and seis stations 
c     ALLSTAT: GPS pure statics (2), gps-grams (1), normal seismograms (0)
...
c  scisola change: automatic reply
c      read(*,*) reply
