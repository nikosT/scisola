...
c scisola change: no input file, static vars
      ics=7   !true step
      t0=0.
      t1=0.
      icc=2   !output = velocity

c        open(301,file='soutype.dat')
c        read(301,'(i1)') ics
...
45         temp = a0 + a2                                                 
          ...
          b3 = b1 - b3                                                   
          b1 = temp                                                      
          a(k0) = complex(a0+a1,b0+b1)                                     
          a(k1) = complex(a0-a1,b0-b1)                                     
          a(k2) = complex(a2-b3,b2+a3)                                     
          a(k3) = complex(a2+b3,b2-a3)                                     
50      continue                                                          
       if (k .le. 1) go to 55                                            
       k = k - 2                                                         
       go to 30                                                          
